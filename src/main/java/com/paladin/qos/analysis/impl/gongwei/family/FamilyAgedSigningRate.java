 ...
 * 
 * @author MyKite
 * @version 2019年9月11日 下午4:30:27
 */
@Deprecated
public class FamilyAgedSigningRate extends GongWeiDataProcessor {

	@Autowired
	private SqlSessionContainer sqlSessionContainer;

	public static final String EVENT_ID = "21026";
	...
	public long getEventNum(Date startTime, Date endTime, String unitId) {
		...
		return sqlSessionContainer.getSqlSessionTemplate().getMapper(DataFamilyDoctorMapper.class).agedSigningRate(startTime, endTime, unit);
	}
}
