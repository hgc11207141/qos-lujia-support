...
@Component
public class Zhencha extends YiyuanDataProcessor {

	@Autowired
	private SqlSessionContainer sqlSessionContainer;

	public static final String EVENT_ID = "90001";
	...
	public long getTotalNum(Date startTime, Date endTime, String unitId) {
		...
		double cost=sqlSessionContainer.getSqlSessionTemplate().getMapper(YiBaoMapper.class).getZhenChaCost(params)*100;
		return (long)cost;
	}
