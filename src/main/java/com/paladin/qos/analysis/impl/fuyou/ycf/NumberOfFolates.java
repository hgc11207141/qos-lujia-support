...
public class NumberOfFolates extends FuyouDataProcessor {
	...
	public static final String EVENT_ID = "13317";
	...
	public long getTotalNum(Date startTime, Date endTime, String unitId) {
		...
		return sqlSessionContainer.getSqlSessionTemplate().getMapper(MaternalManagementMapper.class).getNumberOfFolatesNumber(startTime, endTime, unitId);
	}
