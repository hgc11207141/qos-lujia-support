 ...
 */
@Component
public class OutpatientFee extends YiyuanDataProcessor{

	@Autowired
	private SqlSessionContainer sqlSessionContainer;

	public static final String EVENT_ID = "60002";
	...
	public long getTotalNum(Date startTime, Date endTime, String unitId) {
		...
		return (long)(sqlSessionContainer.getSqlSessionTemplate().getMapper(PerformanceMapper.class).getOutpatientFee(startTime, endTime)*100);
	}
