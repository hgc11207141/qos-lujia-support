 ...
 */
@Component
public class AppointmentNum extends YiyuanDataProcessor{

	@Autowired
	private SqlSessionContainer sqlSessionContainer;

	public static final String EVENT_ID = "41001";
	...
	public long getTotalNum(Date startTime, Date endTime, String unitId) {
		...
		return sqlSessionContainer.getSqlSessionTemplate().getMapper(OpdStatisticsMapper.class).getAppointmentNum(startTime, endTime);
	}
