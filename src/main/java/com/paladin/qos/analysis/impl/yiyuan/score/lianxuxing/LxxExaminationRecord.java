...
public class LxxExaminationRecord extends YiyuanDataProcessor {
    ...
    public static final String EVENT_ID = "91004";
    ...
    public long getTotalNum(Date startTime, Date endTime, String unitId) {
        ...
        return sqlSessionContainer.getSqlSessionTemplate().getMapper(HospitalContinuityScoreMapper.class).getExaminationrecordTotalNum(startTime,endTime,unitId);
    }
