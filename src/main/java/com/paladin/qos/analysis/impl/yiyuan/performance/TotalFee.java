 ...
 */
@Component
public class TotalFee extends YiyuanDataProcessor{

	@Autowired
	private SqlSessionContainer sqlSessionContainer;

	public static final String EVENT_ID = "60005";
	...
	public long getTotalNum(Date startTime, Date endTime, String unitId) {
		...
		return (long)(sqlSessionContainer.getSqlSessionTemplate().getMapper(PerformanceMapper.class).getTotalFee(startTime, endTime)*100);
	}
